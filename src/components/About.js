...
export default function About(prop) {
  ...
  return (
    <>
      <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4" style={{backgroundColor:prop.styleTheme.textAreaBg, color:prop.styleTheme.color}}>
